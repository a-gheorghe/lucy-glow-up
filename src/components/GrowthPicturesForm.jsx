...
export const GrowthPicturesForm = () => {
      ...
      uploadTask.on('state_changed',
          ...
          () => {
              ...
              uploadTask.snapshot.ref.getDownloadURL().then((downloadURL) => {
                  firestore.collection("lucy-growth-pictures").doc(uniId).set({
                      file_name: selectedFile.name.toString(),
                      attributes: ["Plexus", "Lucy", "growth"],
                      description: `Picture of Lucy and Plexus on ${dayjs(selectedDate).format("dddd, MMMM D YYYY")}`,
                      id: uniId,
    ...
    <MuiPickersUtilsProvider utils={DayjsUtils}>
      ...
      <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
        ...
        <DatePicker value={selectedDate} onChange={setSelectedDate} />
            ...
            <input style={{ display: 'none' }} accept="image/*" id="icon-button-file" type="file" onChange={onSelectFile} />
            {selectedFile &&  <img src={preview} height="200" width="200" alt={selectedFileDescription.trim().length > 0 ? selectedFileDescription : "preview"} /> }
        </DialogContent>
        <DialogActions>
